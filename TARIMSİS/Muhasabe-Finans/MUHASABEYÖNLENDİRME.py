...
class AdminPanel(QMainWindow):
    def __init__(self, kullanici_adi):
        ...
        logo_label = QLabel()
        logo_pixmap = QPixmap("resimler\Agronova (1).png")
    ...
    def create_cards(self, layout):
        card_info = [
            ("Malzeme Ve Ürün Alma", r"Muhasabe-Finans\alım.py"),
            ("Satış Analiz", r"Muhasabe-Finans\analiz.py"),
            ("SSatış Arabirimi", r"Muhasabe-Finans\satış.py"),
            ("Maşş Ödeme", r"Muhasabe-Finans\maaş.py"),
            ("Hayvan Satış", r"Muhasabe-Finans\hayvansatış.py"),
            ("Gider", r"Muhasabe-Finans\gider.py"),
            ("Gelir", r"Muhasabe-Finans\gelir.py"),
            ("Gelir-Gider Analiz", r"Muhasabe-Finans\gelirgideranaliz.py"),
        ]
