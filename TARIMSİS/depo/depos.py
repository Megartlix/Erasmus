...
class AdminPanel(QMainWindow):
    def __init__(self, kullanici_adi):
        ...
        self.setWindowTitle('DEPO KONTROL PANELİ')
    ...
    def create_cards(self, layout):
        ...
        card_info = [
            ("Stok Arabirimi", r"C:\Users\Süleyman AKBULUT\Music\TARIMSİS\depo\stok.py"),
            ("Depo Arabirimi", r"C:\Users\Süleyman AKBULUT\Music\TARIMSİS\depo\depo.py"),
            ("Stok Ve Satış Analiz Arabirimi", r"C:\Users\Süleyman AKBULUT\Music\TARIMSİS\depo\analiz.py"),
             ("Barkod  Oluşturma  Arabirimi", r"C:\Users\Süleyman AKBULUT\Music\TARIMSİS\depo\Barkod.py"),
