...
class AdminPanel(QMainWindow):
    ...
    def create_cards(self, layout):
        card_info = [
            ("İş Merkezi", "işmerkezi\dosya1.py"),
            ("Depo Kontrol Sistemi", "depo\depos.py"),
            ("Sulama Sistemi", "Sulama_Sistemi\Sulama_Yönlendirme.py"),
            ("Hayvan Yönetim Sistemi", "Beshane_sistemi\beshaneyönlendirme.py"),
            ("Tarla Kontrol Sistemi", "tarla sistemi\tarla.py"),
            ("Muhasabe", "Gelir-Gİder-Maliyet\muhasebe.py"), 
