...
class AdminPanel(QMainWindow):
    def __init__(self, kullanici_adi):
        ...
        self.setWindowTitle('FORMEN PANELİ')
    ...
    def create_cards(self, layout):
        ...
        card_info = [
            ("Görev Ekleme ", "işmerkezi\gorev_ver.py"),
            ("İşçi Ekle", "işmerkezi\isci_ekle.py"),
            ("Devamsızlıklar giriş", "işmerkezi\işçi_devam.py"),
            ("Depo Kontrol   ", "depo\depos.py"),
            ("Beshane Durum  ", "Beshane_sistemi\Hayvan.py"),
             ("MUHASABE   ", "Beshane_sistemi\Hayvan.py"),
