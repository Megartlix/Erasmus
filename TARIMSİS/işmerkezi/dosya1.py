...
class AdminPanel(QMainWindow):
    ...
    def create_cards(self, layout):
        card_info = [
            ("Formen Ekle", "işmerkezi/formen_ekle.py"),
            ("Görev Ver", "işmerkezi/gorev_ver.py"),
            ("İşçi Ekle", "işmerkezi/isci_ekle.py"),
            ("Performans", "işmerkezi/isci_performans.py"),
            ("Devam Durumu", "işmerkezi/devam_durumu.py"),
            ("İşçi Devam", "işmerkezi/isci_devam.py"),
        ]
